...
| 03 | [Data model](03-data-model.md) | P4 + P2 | Supabase tables, indexes, migrations |
...
| 06 | [Tools](06-tools.md) | P4 | Web search + calculator tool specs |
| 07 | [Frontend](07-frontend.md) | P3 | Courtroom UI, SSE client, art pipeline |
| 08 | [Evaluation](08-evaluation.md) | P1 | KPIs, eval harness, LLM-judge rubrics |
| 09 | [Infra, env & API keys](09-infra-and-keys.md) | P4 | Deploys, every env var and API key, secrets, demo mode, cost caps |
